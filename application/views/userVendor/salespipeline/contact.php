...
$(document).ready(function() {
    ...
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('userVendor/salespipeline/ajax_list')?>",
            "type": "POST"
        },
...
<script type="text/javascript">
     $(document).ready(function(){
       ...
       $("#doneBtnFeature").click(function(){
        ...
        $(".btnAddcon").click(function(){
            ...
            $("#ContactID").val('');
            var contactForm =  $("#contactForm").attr("action","<?=base_url()?>userVendor/salespipeline/insertcontact");
        });
		...
		$("#EditProfile").click(function(){
            ...
            $.ajax({
                url: "<?=base_url()?>userVendor/salespipeline/get_contact_detail/"+contactProfileId,
                type: 'post',
                dataType: "json",
                success: function(response){
                	...
                	}else
                	{
						...
						var contactForm =  $("#contactForm").attr("action","<?=base_url()?>userVendor/salespipeline/update_contact_detail");
     ...
     {
     	$.ajax({
                url: "<?=base_url()?>userVendor/salespipeline/get_contact_detail/"+id,
                type: 'post',
                dataType: "json",
                success: function(response){
                	if(response.status =='error')
     ...
     function get_note_contact(id)
     {
     		  	...
     		  	$.ajax({
                url: "<?=base_url()?>userVendor/salespipeline/get_note_contact/"+id,
                type: 'post',
                dataType: "json",
                success: function(response){
                	if(response.status =='error')
