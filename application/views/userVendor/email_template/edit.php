...
<div class="content-wrapper">
   ...
   <section class="content-header">
        <h1>
            <a href="<?php echo base_url();?>userVendor/email_template"> <i class="fa fa-envelope" aria-hidden="true"></i> Email Template</a>
            <small>Edit</small>
        </h1>
    </section>
            ...
            <div class="col-md-12">
              <!-- general form elements -->
                <div class="box box-primary">
                    ...
                    <form role="form" id="addCategory" action="<?php echo base_url() ?>userVendor/email_template/update/<?php echo $edit_data->id;?>" method="post" role="form" enctype="multipart/form-data">
                        <div class="box-body">
