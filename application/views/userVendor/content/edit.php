...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <a href="<?php echo base_url();?>userVendor/content"> <i class="fa fa-file-text-o" aria-hidden="true"></i> Page Content</a>
        <small>Edit</small>
      </h1>
    </section>
            ...
            <div class="col-md-12">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                   ...
                   <form role="form" id="member_form" action="<?php echo base_url() ?>userVendor/content/update" method="post" role="form" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
