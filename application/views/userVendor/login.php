...
<html>
  ...
  <body class="login-page"  style="background-image: url('../assets/images/about1.jpg');
  ...
  background-size: cover;background-position: center;">
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <form action="<?php echo base_url(); ?>userVendor/login/loginMe" method="post">
          ...
          <div class="row">
            ...
            <div class="col-sm-8">
              <a class="pull-right" href="<?= base_url('userVendor/register')?>">Register Now</a>
            </div><!-- /.col -->
          </div>
        </form>
