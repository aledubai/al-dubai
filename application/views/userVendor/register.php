...
<html>
  <head>
    <meta charset="UTF-8">
    <title>User Vendor Registration </title>
  ...
  <body class="login-page" style="background-image: url('../assets/images/dubaiReg.jpg');
  ...
  background-size: cover;background-position: center;background-color: #985e5e;">
    <div class="login-box" style='margin: 4% auto' >
      ...
      <div class="login-box-body">
        ...
        <form action="<?php echo base_url(); ?>userVendor/register/insertnow" method="post">
          ...
          <div class="row">
            ...
            <div class="col-sm-8">
              ...
              <label><small>Already Register</small>&nbsp;&nbsp;&nbsp;<a class="pull-right" href="<?= base_url('userVendor/login')?>">Login Now</a>
              </label> 
