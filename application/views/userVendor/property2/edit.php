...
<form role="form" id="property_form" class="form-horizontal" action="<?php echo base_url() ?>userVendor/property2/insertnow" method="post" role="form" enctype="multipart/form-data">
