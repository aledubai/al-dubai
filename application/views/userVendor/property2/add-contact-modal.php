		            		...
		            		<div class="col-sm-6">
		            			<div class="form-row ">
				                    <label for="AlternateMobile" class="control-label">Alternate Mobile:</label>
				                     <input type="text" class="form-control input-sm validMobile numberOnly " id="AlternateMobile" name="AlternateMobile" value="<?php echo (isset($PropertyLandlordData->AlternateMobile) && $PropertyLandlordData->AlternateMobile !== '') ? $PropertyLandlordData->AlternateMobile : '';?>" maxlength="12" />
				                </div>
		            		</div>
		            	</div>
		            	<div class="row">
