    ...
    <div class="themeModalCon">
        ...
        <div class="row">
            <div id="previewFloorPlan">
                 ...
                 <input type="hidden" readonly name="prop_lat" id="prop_lat" class="prop_lat"   value="<?php  echo (isset($PropertyData->prop_lat) && $PropertyData->prop_lat !== '') ? ($PropertyData->prop_lat) : '';?>"  />
                 <input type="hidden"  readonly  name="prop_lng" id="prop_lng" class="prop_lng" value="<?php  echo (isset($PropertyData->prop_lng) && $PropertyData->prop_lng !== '') ? ($PropertyData->prop_lng) : '';?>"  />
