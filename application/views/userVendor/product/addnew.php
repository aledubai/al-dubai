...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
         <a href="<?php echo base_url();?>userVendor/product"> <i class="fa fa-th" aria-hidden="true"></i> Product</a>
            ...
            <div class="col-md-12">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="member_form" action="<?php echo base_url() ?>userVendor/product/insertnow" method="post" role="form" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
									<!--name-->                             
...
<script>
    $("#category_id").change(function(){
        ...
        {
            type:"POST",
            url:"<?php echo base_url();?>userVendor/product//get_sub_category", 
            data:"id="+id,
