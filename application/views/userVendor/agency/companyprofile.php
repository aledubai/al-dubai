...
<section class="content">
    ...
    <!-- Content Starts Now-->
        ...
        <div class="box-body">
            <form action="<?=base_url()?>userVendor/agency/add_company_profile" method="POST" id="companyForm"  enctype="multipart/form-data" >
            <div class="row">
                <div class="col-sm-6">
    ...
    $(document).ready(function(){
        ...
        $('#uploadLogo').on('change', function(e){
            ...
            {  
                ...
                $.ajax({  
                url:"<?php echo base_url(); ?>userVendor/ajax_upload_file/company_profile_logo", //Image Path defined in ajax upload file  
                method:"POST",  
                data:form_data,  
                contentType: false, 
                cache: false,  
