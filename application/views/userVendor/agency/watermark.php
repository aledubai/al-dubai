    ...
    <section class="content">
        <div class="box">
            <small style="margin-left: 20px; color: green; font-style: italic;"><b>Watermark is active</b></a></small>
                <!-- Body Content Starts-->
                <div class="box-body">
                    <form action="<?=base_url()?>/userVendor/agency/upload_overlay_stamp" >
                        <div class="row">
                            <div class="col-sm-12">
 ...
 alert(watermarkName);
        if(watermarkName !=='')
        {
            ...
            var els = document.getElementsByName('water_position');
             ...
             $.ajax({  
                    url:"<?php echo base_url(); ?>userVendor/ajax_upload_file/watermark_setting_stamp",   
                    method:"POST",  
                    data:form_data,  
                    contentType: false,  
                    cache: false,  
    ...
    function upload_stamp()
    {
         if($('#upload_overlay_stamp').val() == '')  
            ...
            {  
                ...
                $.ajax({  
                url:"<?php echo base_url(); ?>userVendor/ajax_upload_file/watermark_upload_stamp",   
                method:"POST",  
                data:form_data,  
                contentType: false,  
                cache: false,  
