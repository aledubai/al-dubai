...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <i class="fa fa-sitemap" aria-hidden="true"></i>Cleaning and Maintenance
         
      </h1>
    </section>
    <section class="content">
      <form action="<?=base_url()?>about/testModel" method="POST" id="singUpForm" enctype="multipart/form-data" autocomplete="off">
        <!-- <div class="row">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Building List</h3>
                     <div class="box-tools">
        ...
        //$('#example').DataTable();
         ...
         jQuery(document).on("click", ".deletebtn", function(){
          ...
          var userId = $(this).data("userid"),
            hitURL = "<?php echo base_url() ?>admin/types/delete",
            currentRow = $(this);
...
$(document).ready(function() {
    ...
    table = $('#example2').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/types/cleaningAjax_list')?>",
            "type": "POST"
        },
    ...
    jQuery(document).ready(function(){
         jQuery(document).on("change", ".statusBtn", function(){
          ...
          var value  = $(this).val();
            ...
            hitURL = "<?php echo base_url() ?>admin/types/statusChange",
            currentRow = $(this);
