...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
         <a href="<?php echo base_url();?>vendor/property"> <i class="fa fa-pie-chart" aria-hidden="true"></i> Property</a>
            ...
            <div class="col-md-12">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="property_form" action="<?php echo base_url() ?>vendor/property/insertnow" method="post" role="form" enctype="multipart/form-data">
                        <div class="box-body">
