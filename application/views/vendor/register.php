      ...
      <div class="login-box-body">
        ...
        <form action="<?php echo base_url(); ?>vendor/register/insertnow" method="post">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="First Name" name="fname" required value="<?php echo set_value('fname') ?>" />
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
          </div>
           <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="Last Name" name="lname" required value="<?php echo set_value('lname') ?>" />
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
          ...
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="Mobile Number" name="phone" required value="<?php echo set_value('phone') ?>"/>
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
            <div class="input-group">
                                         <input type="password" class="form-control" placeholder="Password" name="password" id="vendor_signup_password" required value="<?php echo set_value('password') ?>" />
                                      <div class="input-group-append">
                                         <i id="vendor_signup_eye" onclick="password_toggle('vendor_signup_password','vendor_signup_eye')" class="btn btn-success fa fa-eye "></i> 
