...
<!-- form start -->
<form role="form" id="property_form" class="form-horizontal" action="<?php echo base_url() ?>vendor/property2/update" method="post" role="form" enctype="multipart/form-data">
              ...
              <!-- general form elements -->
                <div class="box box-primary">
                    <div class="box-header">
                        <input type="hidden" name="id" id="id" value="<?php  echo $PropertyData->id;?>" required />
                    </div> 
                    <div class="box-body">
                        <div class="row">
                            <div class="col-sm-4">
                                   ...
                                   <div id="EnLanguage">
                                    ...
                                    <div class="form-group">
                                            <label for="slug_url" class="col-sm-3 control-label">Slug Url <strong class="text-danger">*</strong></label><br>
                                                ...
                                                <input type="text" id="slug_url" name ="slug_url" class="form-control"   readonly  onkeyup="check_slug()" required="required" value="<?php  echo $PropertyData->slug_url;?>"  >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control input-sm" name="user_id" id="user_id" required>
                                                 ...
                                                 {
                                                    ?>
                                                        <option value="<?=$k ?>" <?php if(isset($PropertyData->user_id) && $PropertyData->user_id == $k){ echo "Selected";} ?> > <?= $v ?></option>
                                                        <?php } 
                                                        ?>
                                            </select>
                    ...
                    <div class="box-footer">
                        <div class="row " >
                            <div class="col-sm-6">
                                <input type="submit" class="btn btn-rc" value="Submit" id="submit" />
