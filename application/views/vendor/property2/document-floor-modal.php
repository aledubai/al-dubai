                            ...
                            foreach ($PropertyDocsDataVal as $k =>$v ){ 
                                if(isset($k) &&  $k !=='')
                                {
                                    ...
                                    <div class="col-sm-4 mt-4 alert alert-secondary box-shadow-rc alert-dismissable">
                                        ...
                                        <input type="text" readonly  name="docsName[]" value="<?=$v?>" />
                                    </div>
                                <?php     
                                }
                            } 
...
<!--Script Document Floor Modal start-->
 <script type="text/javascript">
        $(document).ready(function(){
            ...
            {  
                ...
                $.ajax({  
                url:"<?php echo base_url(); ?>vendor/ajax_upload_file/multipleDocsStore",   
                method:"POST",  
                data:form_data,  
                contentType: false,  
                cache: false,  
 ...
 function readDocsPlan(file,index)
 {
    ...
    reader.onload = function(_file) {
        ...
        n = file.name,
        s = ~~(file.size/1024) +'KB';
        $('#previewDocument').append('<div class="col-sm-4 mt-4 alert alert-secondary box-shadow-rc alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><i class="fa fa-file fa-5x" style="height:160px;width: 100%;" ></i><input type="text" style="width: 100%;" name="DocsTitle[]" placeholder="Enter Title" ><input type="text" readonly name="docsName[]"  id="docsName'+index+'"></div>');
