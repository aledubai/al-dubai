...
<div class="content-wrapper"><!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><button type="button" class="btn btn-primary btnAddStaff text-right" ><i class="fa fa-plus" ></i>&nbsp;&nbsp;ADD AGENT</button></li>
        </ol>
...
var table;
    ...
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('vendor/agency/ajax_staff_list')?>",
            "type": "POST"
        },
        ...
        //$('#example').DataTable();
         ...
         jQuery(document).on("click", ".deletebtn", function(){
          ...
          var userId = $(this).data("userid"),
            hitURL = "<?php echo base_url() ?>vendor/agency/deleteagent",
            currentRow = $(this);
     ...
     function setblank()
    {
     ...
     function editStaff(id)
     {
        $(".themeModal").addClass("hidden");
            ...
            $.ajax({
            url: "<?=base_url()?>vendor/agency/get_staff_detail/"+id,
            type: 'post',
            dataType: "json",
            success: function(response){
                ...
                }else
                {
                    ...
                    $("#StaffPrimaryNumber").val(data.StaffPrimaryNumber);
                ...
                '<img style="height:160px;width: 100%;" src="<?=base_url()?>uploads/agency/staff/'+data.StaffTumbnail+'" class="thumb"><input type="hidden"  name="StaffuploadImageName"  id="StaffuploadImageName" style="width:100%;" value="'+data.StaffTumbnail+'">' +'</div>');
                    ...
                    $("#StaffForm #StaffTeam").val(data.StaffTeam);
                    $("#StaffForm #StaffNationality").val(data.StaffNationality);
