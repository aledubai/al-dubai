...
<div class="themeModal hidden" id="themeStaff">
    <div class="themeModalCon">
        <div class="row">
            ...
            <hr>
            <form class="form-horizontal" action="<?=base_url()?>vendor/agency/add_new_staff" id="StaffForm" enctype="multipart/form-data" >
            <!-- col-12-->
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control input-sm" name="StaffPrimaryNumber" id="StaffPrimaryNumber" maxlength="15" required="" />
                                        </div><!-- 
                                        <div class="col-sm-4">
                            ...
                            <div class=" form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control input-sm" name="StaffSecondaryTextFirst" id="StaffSecondaryTextFirst"  maxlength="15"   />
                                        </div>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control input-sm" name="StaffSecondaryTextSecond" id="StaffSecondaryTextSecond"  maxlength="15" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control input-sm" name="StaffFaxFirst" id="StaffFaxFirst" maxlength="15"/>
                                        </div>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control input-sm" name="StaffFaxSecond" id="StaffFaxSecond" maxlength="15"/>
                                        </div>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control input-sm" name="StaffFaxThird" id="StaffFaxThird" maxlength="15"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class=" form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="">
                                        <input type="text" class="form-control input-sm" name="StaffZip" id="StaffZip" maxlength="8"/>
                                    </div>
                                </div>
                            </div>
                            <div class=" form-group">
                            ...
                            <div class=" form-group">
                                ...
                                <div class="col-sm-10">
                                   <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-row"> 
                                                <input type="radio" name="StaffIsActive" id="StaffIsActive<?=$k?>" value="<?=$k?>" <?php echo $echecked;?> 
                                                 >&nbsp;&nbsp;&nbsp;
                            ...
                            <div class=" form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="">
                                        <input type="text" class="form-control input-sm" name="StaffSkype" id="StaffSkype" maxlength="25"/>
                                    </div>
                                </div>
                            </div>
                            <div class=" form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="">
                                        <input type="text" class="form-control input-sm" name="StaffWhatsApp" id="StaffWhatsApp"  maxlength="15"/>
                                    </div>
                                </div>
                            </div>
                             <div class=" form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="">
                                        <input type="text" class="form-control input-sm" name="StaffPassport" id="StaffPassport"  maxlength="25"/>
                                    </div>
                                </div>
                            </div>
     ...
     $(function() {
        ...
        $('#StaffuploadImage').on('change', function(e){
            ...
            {  
                ...
                $.ajax({  
                url:"<?php echo base_url(); ?>vendor/ajax_upload_file/staff_upload_thumbnail",   
                method:"POST",  
                data:form_data,  
                contentType: false,  
                cache: false,  
