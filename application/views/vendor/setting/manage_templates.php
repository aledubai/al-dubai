...
<section class="content">
    <div class="box">
        ...
        <!-- Body Content Starts-->
        <div class="box-body">
        <form action="<?=base_url()?>vendor/setting/add_setting_template" method="POST" id=""  enctype="multipart/form-data" >
        <div class="row">
            <div class="col-sm-12">
                    <!-- Flashdata Code-->
                    <?php
...
var table;
    ...
    table = $('#example').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('vendor/setting/ajax_mailingTemp_list')?>",
            "type": "POST"
        },
