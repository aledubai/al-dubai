...
class Register extends BaseController
{
    ...
    public function insertnow()
    {
        ...
        else
        {
               ...
               $this->session->set_flashdata('error', $form_data['email'].' already Exist.');
                ...
                if($result > 0)
                {
                    ...
                    $where['email']  = $comfirmmail;
                     $reg_dtl = $this->user_model->findDynamic($where);
                     $reg_dtl = $reg_dtl[0];
                    ...
                    $this->session->set_flashdata('success', 'Registration successfully<br><a href="'.$verification_url.'">Verify Email Only For Local</a>');
                }
                else
                { 
            ...
            redirect(base_url().'vendor/register');
          }  
