...
class Property2 extends BaseController
{
    ...
    public function addnew()
    {
        ...
        $data['saleList']  = $this->type_model->saleList();
		 ...
		 //AgencyList
        $data['listAgencyTo']  = $this->type_model->listAgencyTo();
...
public function editnew($id= null)
    ...
    public function insertnow()
    {
        ...
        else
        {
            ...
            $insertData['meta_alt']      = $form_data['meta_alt'];
    ...
    public function ajax_list()
    {
        ...
        $list = $this->property2_model->get_datatables($user_id);
...
$checkbox = '<input class="form-check-input" type="checkbox" value="" id="flexCheckChecked" checked>';
            ...
            $row[] = $btn;
             ...
             $row[] = '<div class="progress progress-xs bg-aqua">
                <div class="progress-bar progress-bar-warning progress-bar-striped" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%">
                   
                </div>
              </div><div class="progress progress-xs bg-aqua">
            ...
            $row[] = '<a class="" href="'.base_url().'vendor/property2/editnew/'.$currentObj->id.'" title="Edit" ><i class="fa fa-pencil-square-o"></i></a>&nbsp;&nbsp;<a href="#" title="Print"><i class="fa fa-file-text-o"></i></a> <a class="deletebtn" href="#" data-userid="'.$currentObj->id.'"  title="Delete" ><i class="fa fa-archive"></i></a>';
            $data[] = $row;
        }
 
        $output = array(
                        "draw" => (isset($_POST['draw']))?$_POST['draw']:'',
                        "recordsTotal" => $this->property2_model->count_all($user_id),
                        "recordsFiltered" => $this->property2_model->count_filtered($user_id),
                        "data" => $data,
                );
	...
	public function check_property_slug()
    { 
         ...
         if(isset($form_data['slug_url']))
         {
            ...
            $result = $this->property2_model->sqls_query($wheres);
            if(count($result) > 0)
            {
                echo 'slug_exist';
            }else
