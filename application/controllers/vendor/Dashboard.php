...
class Dashboard extends BaseController
{
    ...
    public function index()
    {
        ...
        $leads_list =  $this->contact_agent_model->findDynamic($where);
        ...
        $property_list =  $this->property2_model->findDynamic($where);
        $data['property_list']  = $property_list;


        $this->global['pageTitle'] = 'Ale-izba : Dashboard';
        
        $this->vendorView("vendor/dashboard", $this->global,  $data , NULL);
    }
