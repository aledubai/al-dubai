...
class Email extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->userVendorView("userVendor/email/list", $this->global, NULL , NULL);
    ...
    public function compose()
    {
        ...
        $this->userVendorView("userVendor/email/compose", $this->global, $data , NULL);
    ...
    public function insertnow()
    {
        ...
        else
        {
            ...
            redirect('userVendor/email/compose');
          }  
