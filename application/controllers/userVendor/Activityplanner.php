...
class Activityplanner extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = array();
        $this->global['pageTitle'] = 'Activityplanner : User Al-Eizba';
        $this->userVendorView("userVendor/activityplanner/task", $this->global, $data , NULL);
    ...
    public function task()
    {
        ...
        $data = array();
        $this->global['pageTitle'] = 'Activityplanner-Task : User Al-Eizba';
        $this->userVendorView("userVendor/activityplanner/task", $this->global, $data , NULL);
    ...
    public function notes()
    {
        ...
        $data = array();
        $this->global['pageTitle'] = 'Activityplanner-Notes : User Al-Eizba';
        $this->userVendorView("userVendor/activityplanner/notes", $this->global, $data , NULL);
    ...
    public function email()
    {
        ...
        $data = array();
        $this->global['pageTitle'] = 'Activityplanner-Email : User Al-Eizba';
        $this->userVendorView("userVendor/activityplanner/email", $this->global, $data , NULL);
    ...
    public function log()
    {
        ...
        $data = array();
        $this->global['pageTitle'] = 'Activityplanner-Log : User Al-Eizba';
        $this->userVendorView("userVendor/activityplanner/log", $this->global, $data , NULL);
    ...
    public function leadmanagement()
    {
        ...
        $data = array();
        $this->global['pageTitle'] = 'Salespipeline : User Al-Eizba';
        $this->userVendorView("userVendor/activityplanner/leadmanagement", $this->global, $data , NULL);
    ...
    public function addnew()
    {
        ...
        $this->isUserLoggedIn();
        $data = array();
        $this->global['pageTitle'] = 'Add New Agency : User Al-Eizba';
        $this->userVendorView("userVendor/activityplanner/addnew", $this->global, $data , NULL);
    ...
    public function insertnow()
    {
        ...
        else
        {
            ...
            redirect('userVendor/activityplanner/addnew');
          }  
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $currentObj) {
            ...
            $row[] = $dateAt;
            $row[] = $btn;
            $row[] = '<a class="btn btn-sm btn-info" href="'.base_url().'userVendor/activityplanner/edit/'.$currentObj->id.'" title="Edit" ><i class="fa fa-pencil"></i></a>&nbsp;<a class="btn btn-sm btn-danger deletebtn" href="#" data-userid="'.$currentObj->id.'"><i class="fa fa-trash"></i></a>';
            $data[] = $row;
        }
    ...
    public function edit($id = NULL)
    {
        ...
        $this->userVendorView("userVendor/activityplanner/edit", $this->global, $data , NULL);
    ...
    public function update()
    {
        ...
        else
        {
            ...
            redirect('userVendor/activityplanner/edit/'.$insertData['id']);
          }  
