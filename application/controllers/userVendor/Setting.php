...
class Setting extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->global['pageTitle']  = 'Profile Settings : User Al-Eizba';


        $this->userVendorView("userVendor/setting/profile", $this->global, $data , NULL);
    ...
    public function manage_template()
    {
        ...
        $this->global['pageTitle']  = 'Manage Templates : User Al-Eizba';


        $this->userVendorView("userVendor/setting/manage_templates", $this->global, $data , NULL);
    ...
    public function mailing_lists()
    {
        ...
        $data = array();
        $data['listNationality']    = $this->type_model->listNationality();
        $this->global['pageTitle']  = 'Mailing Lists : User Al-Eizba';


        $this->userVendorView("userVendor/setting/mailing_lists", $this->global, $data , NULL);
    ...
    public function image_bank()
    {
        ...
        $this->global['pageTitle']  = 'Image Bank : User Al-Eizba';


        $this->userVendorView("userVendor/setting/image_bank", $this->global, $data , NULL);
    ...
    public function floor_plan_bank()
    {
        ...
        $data = array();
        $data['listNationality']    = $this->type_model->listNationality();
        $this->global['pageTitle']  = 'Floor Plan Bank : User Al-Eizba';


        $this->userVendorView("userVendor/setting/floor_plan_bank", $this->global, $data , NULL);
    ...
    public function email_notification()
    {
        ...
        $this->global['pageTitle']  = 'Email Notification : User Al-Eizba';


        $this->userVendorView("userVendor/setting/email_notification", $this->global, $data , NULL);
    ...
    public function password()
    {
        ...
        $data = array();
        $this->global['pageTitle']  = 'Password : User Al-Eizba';
 
         $data['user_data']= $this->password_model->find($_SESSION['userId']);


        $this->userVendorView("userVendor/setting/password", $this->global, $data , NULL);
    ...
    public function add_setting_profile()
    {
        ...
        else
        {
            $insertData = array();
                ...
                redirect('userVendor/setting/profile');
        ...
        public function add_setting_template()
    {
        ...
        // Fields Details
                ...
                redirect('userVendor/setting/manage_template');
        ...
        // Add Mailing List
                public function add_setting_mailingList()
            {
                ...
                redirect('userVendor/setting/mailing_lists');
        ...
        // End Mailing List
                ...
                public function setting_updatePassword()
                {
                    ...
                    else
                    {
                            ...
                            redirect('userVendor/setting/password');
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $currentObj) {
            ...
            $row[] = $dateAt;
            $row[] = $btn;
            $row[] = '<a class="btn btn-sm btn-info" href="'.base_url().'userVendor/agency/edit/'.$currentObj->id.'" title="Edit" ><i class="fa fa-pencil"></i></a>&nbsp;<a class="btn btn-sm btn-danger deletebtn" href="#" data-userid="'.$currentObj->id.'"><i class="fa fa-trash"></i></a>';
            $data[] = $row;
        }
    ...
    public function edit($id = NULL)
    {
        ...
        $this->userVendorView("userVendor/agency/edit", $this->global, $data , NULL);
    ...
    public function update()
    {
        ...
        else
        {
            ...
            redirect('userVendor/agency/edit/'.$insertData['id']);
          }  
