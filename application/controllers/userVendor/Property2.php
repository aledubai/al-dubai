...
class Property2 extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->global['pageTitle'] = 'Property2 : User Al-Eizba';

        $this->userVendorView("userVendor/property2/list", $this->global, $data , NULL);
    ...
    public function addnew()
    {
        ...
        //SaleList
        $data['saleList']  = $this->type_model->saleList();


        $this->global['pageTitle'] = 'Add New Property2 : User Al-Eizba';

        $this->userVendorView("userVendor/property2/addnew", $this->global, $data , NULL);
...
public function editnew($id= null)
    {
        ...
        $data['PropertyImagesData']  = $PropertyImagesData;
        ...
        $data['saleListing']  = $this->type_model->saleList();

        $this->global['pageTitle'] = 'Add New Property2 : User Al-Eizba';

        $this->userVendorView("userVendor/property2/editnew", $this->global, $data , NULL);
    ...
    public function insertnow()
    {
        ...
        else
        {
            ...
            $insertData['saleList']      = $form_data['saleList'];
            ...
            $insertData['prop_lat']       = $form_data['prop_lat'];
            $insertData['prop_lng']       = $form_data['prop_lng'];
            ...
            redirect('userVendor/property2/addnew');
        }  
...
$checkbox = '<input class="form-check-input" type="checkbox" value="" id="flexCheckChecked" checked>';
            ...
            $row[] = '<a class="" href="'.base_url().'userVendor/property2/editnew/'.$currentObj->id.'" title="Edit" ><i class="fa fa-pencil-square-o"></i></a>&nbsp;&nbsp;<a href="#" title="Print"><i class="fa fa-file-text-o"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#"   title="More" ><i class="fa fa-ellipsis-v"></i></a>&nbsp;&nbsp;<br><a class="deletebtn" href="#" data-userid="'.$currentObj->id.'"  title="Delete" ><i class="fa fa-archive"></i></a>';
            $data[] = $row;
        }
    ...
    public function edit($id = NULL)
    {
        ...
        $this->userVendorView("userVendor/property2/edit", $this->global, $data , NULL);
    ...
    public function update()
    {
        ...
        else
        {
            ...
            redirect('userVendor/property2/editnew');
        }
    }
