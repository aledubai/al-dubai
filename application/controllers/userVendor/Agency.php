...
class Agency extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->global['pageTitle']  = 'Manage Staff : User Al-Eizba';


        $this->userVendorView("userVendor/agency/manage-staff", $this->global, $data , NULL);
    ...
    public function manageteam()
    {
        ...
        $data = array();
        $this->global['pageTitle'] = 'Manage-team : User Al-Eizba';
        $this->userVendorView("userVendor/agency/manageteam", $this->global, $data , NULL);
    ...
    public function markettingportal()
    {
        ...
        $data = array();
        $this->global['pageTitle'] = 'Markettingportal : User Al-Eizba';
        $this->userVendorView("userVendor/agency/markettingportal", $this->global, $data , NULL);
    ...
    public function wataermarksetting()
    {
        ...
        $data = array();
        $this->global['pageTitle'] = 'Wataermark Setting : User Al-Eizba';
        $this->userVendorView("userVendor/agency/watermark", $this->global, $data , NULL);
    ...
    public function companyprofile()
    {
        ...
        $this->global['pageTitle'] = 'Company profile : User Al-Eizba';
        $this->userVendorView("userVendor/agency/companyprofile", $this->global, $data , NULL);
    ...
    public function acencysetting()
    {
        ...
        $data = array();
        $this->global['pageTitle'] = 'Agency Setting : User Al-Eizba';
        $this->userVendorView("userVendor/agency/acencysetting", $this->global, $data , NULL);
