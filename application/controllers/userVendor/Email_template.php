...
class Email_template extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->userVendorView("userVendor/email_template/list", $this->global, NULL , NULL);
    ...
    public function addnew()
    {
        ...
        $this->userVendorView("userVendor/email_template/addnew", $this->global, NULL , NULL);
    ...
    public function insertnow()
    {
        ...
        else
        {
            ...
            redirect('userVendor/email_template/addnew');
          }  
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $currentObj) {
            ...
            $row[] = '<a class="btn btn-sm btn-info" href="'.base_url().'userVendor/email_template/edit/'.$currentObj->id.'"><i class="fa fa-pencil"></i></a> <a class="btn btn-sm btn-danger deletebtn" href="#" data-userid="'.$currentObj->id.'"><i class="fa fa-trash"></i></a>';
            $data[] = $row;
        }
    ...
    public function edit($id = NULL)
    {
        ...
        if($id == null)
        {
            redirect('userVendor/email_template');
        }
        
        $data['edit_data'] = $this->email_template_model->find($id);
        $this->global['pageTitle'] = 'zenostrategics : Edit Members';
        $this->userVendorView("userVendor/email_template/edit", $this->global, $data , NULL);
    ...
    public function update()
    {
        ...
        else
        {
            ...
            redirect('userVendor/email_template/edit/'.$insertData['id']);
          }  
