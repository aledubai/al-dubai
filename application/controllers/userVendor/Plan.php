...
class Plan extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->userVendorView("userVendor/plan/list", $this->global, NULL , NULL);
    ...
    public function addnew()
    {
        ...
        $this->userVendorView("userVendor/plan/addnew", $this->global, NULL , NULL);
    ...
    public function insertnow()
    {
        ...
        else
        {
            ...
            redirect('userVendor/plan/addnew');
          }  
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $currentObj) {
            ...
            $row[] = '<a class="btn btn-sm btn-info" href="'.base_url().'userVendor/plan/edit/'.$currentObj->id.'"><i class="fa fa-pencil"></i></a> <a class="btn btn-sm btn-danger deletebtn" href="#" data-userid="'.$currentObj->id.'"><i class="fa fa-trash"></i></a>';
            $data[] = $row;
        }
    ...
    public function edit($id = NULL)
    {
        ...
        if($id == null)
        {
            redirect('userVendor/plan');
        }

        
        $data['edit_data'] = $this->plan_model->find($id);
        $this->global['pageTitle'] = 'Ale-izba : Edit Plan';
        $this->userVendorView("userVendor/plan/edit", $this->global, $data , NULL);
    ...
    public function update()
    {
        ...
        else
        {
            ...
            redirect('userVendor/plan/edit/'.$insertData['id']);
          }  
