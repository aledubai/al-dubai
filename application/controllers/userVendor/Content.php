...
class Content extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->userVendorView("userVendor/content/list", $this->global, NULL , NULL);
    ...
    public function addnew()
    {
        ...
        $this->userVendorView("userVendor/content/addnew", $this->global, NULL , NULL);
    ...
    public function insertnow()
    {
        ...
        else
        {
            ...
            redirect('userVendor/content/addnew');
          }  
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $currentObj) {
            ...
            $row[] = '<a class="btn btn-sm btn-info" href="'.base_url().'userVendor/content/edit/'.$currentObj->id.'"><i class="fa fa-pencil"></i></a> <a class="btn btn-sm btn-danger deletebtn" href="#" data-userid="'.$currentObj->id.'"><i class="fa fa-trash"></i></a>';
            $data[] = $row;
        }
    ...
    public function edit($id = NULL)
    {
        ...
        if($id == null)
        {
            redirect('userVendor/content');
        }

        
        $data['edit_data'] = $this->content_model->find($id);
        $this->global['pageTitle'] = 'Ale-izba : Edit Page Content';
        $this->userVendorView("userVendor/content/edit", $this->global, $data , NULL);
    ...
    public function update()
    {
        ...
        else
        {
            ...
            redirect('userVendor/content/edit/'.$insertData['id']);
          }  
