...
class Members extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->userVendorView("userVendor/members/list", $this->global, NULL , NULL);
    ...
    public function addnew()
    {
        ...
        $this->userVendorView("userVendor/members/addnew", $this->global, NULL , NULL);
    ...
    public function insertnow()
    {
        ...
        else
        {
			...
			if(count($db_data) > 0)
			{
				...
				redirect('userVendor/members/addnew');
				exit;
			}
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $currentObj) {
            ...
            $row[] = '<a class="btn btn-sm btn-info" href="'.base_url().'userVendor/members/edit/'.$currentObj->id.'"><i class="fa fa-pencil"></i></a> <a class="btn btn-sm btn-danger deletebtn" href="#" data-userid="'.$currentObj->id.'"><i class="fa fa-trash"></i></a>';
            $data[] = $row;
        }
    ...
    public function edit($id = NULL)
    {
        ...
        if($id == null)
        {
            redirect('userVendor/members');
        }

        
        $data['edit_data'] = $this->members_model->find($id);
        $this->global['pageTitle'] = 'Ale-izba : Edit Members';
        $this->userVendorView("userVendor/members/edit", $this->global, $data , NULL);
    ...
    public function update()
    {
        ...
        else
        {
            ...
            redirect('userVendor/members/edit/'.$insertData['id']);
          }  
