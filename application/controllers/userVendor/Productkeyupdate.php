...
class Productkeyupdate extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->userVendorView("userVendor/productkeyupdate/list", $this->global, NULL , NULL);
    ...
    public function addnew()
    {
        ...
        $this->userVendorView("userVendor/productkeyupdate/addnew", $this->global, $data , NULL);
    ...
    public function insertnow()
    {
        ...
        else
        {
            ...
            redirect('userVendor/productkeyupdate/addnew');
          }  
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $currentObj) {
            ...
            $row[] = '<a class="btn btn-sm btn-info" href="'.base_url().'userVendor/productkeyupdate/edit/'.$currentObj->id.'" Title="Edit Row" ><i class="fa fa-pencil"></i></a> ';//<a class="btn btn-sm btn-danger deletebtn" href="#" data-userid="'.$currentObj->id.'"><i class="fa fa-trash"></i></a>
            $data[] = $row;
        }
    ...
    public function edit($id = NULL)
    {
		...
		if($id == null)
        {
            redirect('userVendor/productkeyupdate');
        }
		$data = array();
        // edit data 
        ...
        $this->userVendorView("userVendor/productkeyupdate/edit", $this->global, $data , NULL);
    } 
    ...
    public function update()
    {
        ...
        else
        {
            ...
            redirect('userVendor/Productkeyupdate/edit/'.$insertData['id']);
          }  
