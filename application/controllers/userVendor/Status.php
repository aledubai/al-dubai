...
class Status extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->userVendorView("userVendor/status/list", $this->global, $data , NULL);
    ...
    public function addnew()
    {
        ...
        $this->userVendorView("userVendor/status/addnew", $this->global, $data , NULL);
    ...
    public function insertnow()
    {
        ...
        else
        {
            ...
            redirect('userVendor/status/addnew');
          }  
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $currentObj) {
            ...
            $row[] = $currentObj->slug;
            $row[] = $btn;
            $row[] = '<a class="btn btn-sm btn-info" href="'.base_url().'userVendor/status/edit/'.$currentObj->id.'" title="Edit" ><i class="fa fa-pencil"></i></a>&nbsp;';
            $data[] = $row;
        }
    ...
    public function edit($id = NULL)
    {
        ...
        $this->userVendorView("userVendor/status/edit", $this->global, $data , NULL);
    ...
    public function update()
    {
        ...
        else
        {
            ...
            redirect('userVendor/status/edit/'.$insertData['id']);
          }  
