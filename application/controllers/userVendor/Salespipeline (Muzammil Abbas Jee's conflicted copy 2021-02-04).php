...
class Salespipeline extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->userVendorView("userVendor/salespipeline/contact", $this->global, $data , NULL);
    ...
    public function leadmanagement()
    {
        ...
        $this->global['pageTitle'] = 'Salespipeline : Ale-izba';
        $this->userVendorView("userVendor/salespipeline/leadmanagement", $this->global, $data , NULL);
    ...
    public function addnew()
    {
        ...
        $this->userVendorView("userVendor/salespipeline/addnew", $this->global, $data , NULL);
    ...
    public function insertnow()
    {
        ...
        else
        {
            ...
            redirect('userVendor/salespipeline/addnew');
          }  
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $currentObj) {
            ...
            $row[] = $dateAt;
            $row[] = $btn;
            $row[] = '<a class="btn btn-sm btn-info" href="'.base_url().'userVendor/salespipeline/edit/'.$currentObj->id.'" title="Edit" ><i class="fa fa-pencil"></i></a>&nbsp;<a class="btn btn-sm btn-danger deletebtn" href="#" data-userid="'.$currentObj->id.'"><i class="fa fa-trash"></i></a>';
            $data[] = $row;
        }
    ...
    public function edit($id = NULL)
    {
        ...
        $this->userVendorView("userVendor/salespipeline/edit", $this->global, $data , NULL);
    ...
    public function update()
    {
        ...
        else
        {
            ...
            redirect('userVendor/salespipeline/edit/'.$insertData['id']);
          }  
